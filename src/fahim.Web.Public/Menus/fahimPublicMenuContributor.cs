...
namespace fahim.Web.Public.Menus
{
    public class fahimPublicMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public fahimPublicMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<fahimResource>();

            // Home
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    fahimPublicMenus.HomePage,
                    l["Menu:HomePage"],
                    "~/",
                    icon: "fa fa-home",
                    order: 1
            ...
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    fahimPublicMenus.ArticleSample,
